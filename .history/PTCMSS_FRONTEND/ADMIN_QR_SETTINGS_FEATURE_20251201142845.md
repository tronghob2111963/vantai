...
- **File**: `src/components/module 1/AdminPaymentSettings.jsx`
- Features:
...
- **Menu**: Added to `SIDEBAR_ITEMS_BY_ROLE[ROLES.ADMIN]`
  - Label: "Cấu hình thanh toán QR"
  - Icon: `QrCode`
  - Path: `/admin/payment-settings`
- **Route**: Protected với `ProtectedRoute roles={[ROLES.ADMIN]}`
