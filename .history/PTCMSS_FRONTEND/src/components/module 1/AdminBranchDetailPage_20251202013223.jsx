...
export default function AdminBranchDetailPage() {
  ...
  const valid = React.useMemo(() => {
    ...
    return validateBranchName(branchName) === null;
      ...
      </div>ton onClick={onSave} disabled={!valid || saving} className="ml-auto inline-flex items-center gap-1 rounded-md bg-sky-600 hover:bg-sky-500 px-3 py-2 text-sm font-medium text-white shadow-sm disabled:opacity-50">
