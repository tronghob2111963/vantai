...
export default function AdminBranchDetailPage() {
  ...
  const valid = React.useMemo(() => {
    return branchName.trim() !== "" && address.trim() !== "";
  }, [branchName, address]);
  ...
  const onSave = async () => {
    ...
    setSaving(true);
    try {
      const body = { branchName: branchName.trim(), location: address.trim(), status };
        ...
        <div className="grid gap-5">
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="VD: Chi nhánh Hà Nội, Chi nhánh Cần Thơ..."
            />
            {fieldErrors.branchName && (
            ...
            <div className="text-xs text-slate-500 mt-1.5 leading-relaxed">
              💡 Có thể nhập theo định dạng: "Chi nhánh" + Tên tỉnh/thành phố (VD: Chi nhánh Hà Nội)
            </div>
          </div>
