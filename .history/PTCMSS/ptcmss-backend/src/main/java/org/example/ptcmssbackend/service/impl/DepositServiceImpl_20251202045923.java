...
public class DepositServiceImpl implements DepositService {
    ...
    public InvoiceResponse createDeposit(Integer bookingId, CreateInvoiceRequest request) {
        ...
        // cashierName and receiptNumber removed from CreateInvoiceRequest
        // These are now only stored in PaymentHistory and can be set separately if needed
        // paymentHistory.setCashierName(request.getCashierName());
        
        // Generate receipt number
        String receiptNum = generateReceiptNumber(booking.getBranch().getId());
