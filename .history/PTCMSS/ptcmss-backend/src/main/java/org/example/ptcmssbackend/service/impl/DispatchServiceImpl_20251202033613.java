...
public class DispatchServiceImpl implements DispatchService {
    ...
    private void validateVehicleCategoryForReassign(AssignRequest request) {
        try {
            ...
            VehicleCategories newVehicleCategory = newVehicle.getCategory();
            ...
            boolean matchesCategory = bookingVehicles.stream()
                    .anyMatch(bv -> {
                        VehicleCategories bookingCategory = bv.getVehicleCategory();
            ...
            if (!matchesCategory) {
                String requiredCategories = bookingVehicles.stream()
                        .map(bv -> {
                            VehicleCategories cat = bv.getVehicleCategory();
