...
/* DemoAssign để mở AssignDriverDialog */
...
/* ---------------------------------------------------
   ...
   - Item active có viền trái xanh + nền xanh nhạt
--------------------------------------------------- */
        ...
        <div className="text-[13px] text-slate-700">
            ...
            >
                <span className="flex items-center gap-2">
                    ...
                    <span className="font-medium leading-none text-slate-800">
                        {label}
                    </span>
                </span>
...
--------------------------------------------------- */
function SidebarNav() {
    // section đang mở. cho "admin" mở mặc định
    ...
    return (
        <aside className="w-64 bg-white border-r border-slate-200 flex flex-col">
            ...
            <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-4 text-sm">
                ...
                <SidebarSection
                    ...
                    items={[
                        ...
                        {
                            label: "Gán tài xế / Sửa đơn",
                            to: "/orders/ABC123/edit",
                        },
                        {
                ...
                <SidebarSection
                    ...
                    items={[
                        ...
                        {
                            label: "Phiếu tạm ứng tài xế",
                            to: "/dispatch/expense-request",
                        },
                        {
                            label: "Gán tài xế (demo)",
                            to: "/dispatch/AssignDriverDialog",
                        },
                        {
                            label: "Thông báo điều phối",
            ...
            <div className="px-4 py-4 border-t border-slate-200 text-[11px] text-slate-500">
                v0.1 thử nghiệm
            </div>
        </aside>
    );
        ...
        <div className="flex min-h-screen bg-slate-50 text-slate-900">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <main className="flex-1 overflow-y-auto p-5">
                    {/* Ghi chú:
                       Một số màn con (ví dụ dashboard tài xế) hiện vẫn theme dark.
                       Sau này mình có thể refactor sang nền sáng thống nhất.
                    */}
                    <Outlet />
                </main>
            </div>
    ...
    return (
        <Routes>
            ...
            <Route element={<ShellLayout />}>
                ...
                <Route
                    index
                    element={<Navigate to="/analytics/admin" replace />}
                />

                {/* Báo cáo & Phân tích */}
                <Route
                    path="/analytics/admin"
                    element={<AdminDashboardPro />}
                />
                <Route
                    path="/analytics/manager"
                    element={<ManagerDashboardPro />}
                />
                ...
                <Route
                    ...
                    element={<DriverLeaveRequestPage />}
                />
                <Route
                    path="/driver/trips/:tripId"
                    element={<DriverTripDetailPage />}
                />
                ...
                <Route
                    ...
                    element={<VehicleCategoryManagePage />}
                />
                <Route
                ...
                <Route
                    path="/orders"
                    element={<ConsultantOrderListPage />}
                />
                <Route
                    path="/orders/new"
                ...
                <Route
                    path="/dispatch"
                    element={<CoordinatorTimelinePro />}
                />
                <Route
