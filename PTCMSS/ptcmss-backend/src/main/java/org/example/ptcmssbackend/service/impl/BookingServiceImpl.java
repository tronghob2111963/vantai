...
public class BookingServiceImpl implements BookingService {
    ...
    private BookingResponse toResponse(Bookings booking) {
        ...
        BigDecimal paidAmount = invoiceRepository.sumPaidByBookingId(
                booking.getId(),
                org.example.ptcmssbackend.enums.InvoiceType.INCOME,
                org.example.ptcmssbackend.enums.PaymentStatus.PAID
        );
